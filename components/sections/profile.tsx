            ...
            return (
              ...
              >
                <div className="flex items-start gap-4">
                  <div className={`${bgColor} rounded-lg p-3 shrink-0 border border-teal-400/10 group-hover:border-teal-400/30 transition-colors`}>
      ...
      <div className="bg-teal-400/2 rounded-2xl p-8 text-center border border-teal-400/10">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <button 
            ...
            className="cursor-pointer bg-teal-400 text-dark-bg px-6 py-3 rounded-lg font-bold hover:bg-teal-500 transition-all shadow-lg shadow-teal-400/10"
          >
            Get in Touch
          </button>
          <button 
            onClick={() => onSectionChange?.('resume')}
            className="cursor-pointer bg-teal-400/5 text-teal-400 px-6 py-3 rounded-lg font-bold hover:bg-teal-400/10 transition-all border border-teal-400/20"
          >
            View Resume
          </button>
        </div>
